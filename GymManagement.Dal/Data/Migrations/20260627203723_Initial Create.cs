        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_buildingNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Session_Capacity", "[Capacity] Between 1 and 25");
                    table.CheckConstraint("Session_StartTime_EndTime", "[StartTime] < [EndTime]");
                    table.ForeignKey(
